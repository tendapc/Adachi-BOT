...
const avatarTemplate = html`<div class="avatar">
  ...
  <div class="talent" :class="'lv'+data.skills.e_lvl + (data.skills.e_plus ? 'talent_plus':'')">{{data.skills.e.level_current}}</div>
  <div class="talent" :class="'lv'+data.skills.q_lvl + (data.skills.q_plus ? 'talent_plus':'')">{{data.skills.q.level_current}}</div>
</div>`;
